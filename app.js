let pronouns = ['the', 'our', 'my', 'your', 'his', 'her'];
    let adjectives = ['great', 'big', 'orange', 'spooky', 'terrific', 'wonderful', 'amazing', 'painted', 'pretty', 'excellent', 'tasty', 'humble', 'gentle', 'quiet', 'loud'];
    let nouns = ['jogger', 'racoon', 'saloon', 'palace', 'cafe', 'farm', 'hamster', 'deer', 'smokehouse', 'bar', 'music hall', 'beauty shop', 'castle', 'hotel', 'diner', 'theater'];
    let domains = [];
